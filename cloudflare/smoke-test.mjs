...
try {
  ...
  assert.equal(seenByFirst.people.find((person) => person.name === '测试设备乙')?.proximity, 'within-50m');
  ...
  console.log(JSON.stringify({ ok: true, mutualVisibility: true, within50m: true, within100m: true, coordinatesReturned: false }));
} finally {
